       ...
       <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
          ...
          <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
            ...
            <input 
              ...
              required
            />
            {errors.productName && <p className="text-red-600 text-xs">{errors.productName}</p>}
            ...
            <input 
              ...
              required
            />
            {errors.brandName && <p className="text-red-600 text-xs">{errors.brandName}</p>}
            ...
            <input 
              ...
              required
            />
            {errors.sellingPrice && <p className="text-red-600 text-xs">{errors.sellingPrice}</p>}
